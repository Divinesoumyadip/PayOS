...
* **Anomaly Detection**: Utilizes **Z-Score standardization** (\ = (x - \mu) / \sigma\$) to flag transactions outside of 3 standard deviations.
* **Concurrency**: Node.js backend follows **Functional Programming** patterns (immutability) to prevent race conditions during state-updates.
